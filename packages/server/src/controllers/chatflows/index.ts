...
const deleteChatflow = async (req: Request, res: Response, next: NextFunction) => {
    try {
        ...
        if (!userId) {
            throw new InternalFlowiseError(StatusCodes.NOT_FOUND, `Error: chatflowsController.deleteChatflow - user ${userId} not found!`)
        }
...
const getAllChatflows = async (req: Request, res: Response, next: NextFunction) => {
    try {
        ...
        const apiResponse = await chatflowsService.getAllChatflows(req.query?.type as ChatflowType, req.user?.id, page, limit)
        return res.json(apiResponse)
    } catch (error) {
        next(error)
    }
...
const getChatflowByApiKey = async (req: Request, res: Response, next: NextFunction) => {
    try {
        ...
        const apiResponse = await chatflowsService.getChatflowByApiKey(apikey.id, apikey.userId, req.query.keyonly)
        return res.json(apiResponse)
    } catch (error) {
        next(error)
    }
...
const saveChatflow = async (req: Request, res: Response, next: NextFunction) => {
    try {
        ...
        const userId = req.user?.id
        if (!userId) {
            throw new InternalFlowiseError(StatusCodes.NOT_FOUND, `Error: chatflowsController.saveChatflow - user ${userId} not found!`)
        }
        const subscriptionId = ''
        const body = req.body

        const existingChatflowCount = await chatflowsService.getAllChatflowsCountByOrganization(body.type, userId)
...
const updateChatflow = async (req: Request, res: Response, next: NextFunction) => {
    try {
        ...
        const userId = req.user?.id
        if (!userId) {
            throw new InternalFlowiseError(StatusCodes.NOT_FOUND, `Error: chatflowsController.updateChatflow - user ${userId} not found!`)
        }
        ...
        const apiResponse = await chatflowsService.updateChatflow(chatflow, updateChatFlow, userId, subscriptionId)
        return res.json(apiResponse)
    } catch (error) {
        next(error)
    }
...
const getSinglePublicChatflow = async (req: Request, res: Response, next: NextFunction) => {
    ...
    try {
        ...
        if (chatflow.userId !== req.user.id)
            return res.status(StatusCodes.BAD_REQUEST).json({ message: 'You are not the owner of this chatflow' })
...
const checkIfChatflowHasChanged = async (req: Request, res: Response, next: NextFunction) => {
    try {
        ...
        const apiResponse = await chatflowsService.checkIfChatflowHasChanged(req.params.id, req.params.lastUpdatedDateTime, userId)
        return res.json(apiResponse)
    } catch (error) {
        next(error)
    }
...
const setWebhookSecret = async (req: Request, res: Response, next: NextFunction) => {
    try {
        ...
        const apiResponse = await chatflowsService.setWebhookSecret(req.params.id, userId)
        return res.json(apiResponse)
    } catch (error) {
        next(error)
    }
...
const clearWebhookSecret = async (req: Request, res: Response, next: NextFunction) => {
    try {
        ...
        await chatflowsService.clearWebhookSecret(req.params.id, userId)
...
const getScheduleStatus = async (req: Request, res: Response, next: NextFunction) => {
    try {
        ...
        const status = await scheduleService.getScheduleStatus(req.params.id, userId)
        return res.json({
...
const getScheduleTriggerLogs = async (req: Request, res: Response, next: NextFunction) => {
    try {
        ...
        const result = await scheduleService.getTriggerLogs(req.params.id, userId, { page, limit, status })
...
const deleteScheduleTriggerLogs = async (req: Request, res: Response, next: NextFunction) => {
    try {
        ...
        const result = await scheduleService.deleteTriggerLogs(req.params.id, userId, logIds as string[])
        return res.json(result)
    } catch (error) {
        next(error)
    }
...
const toggleScheduleEnabled = async (req: Request, res: Response, next: NextFunction) => {
    try {
        ...
        const record = await scheduleService.toggleScheduleEnabled(req.params.id, userId, enabled)
